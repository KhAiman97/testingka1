        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10 pb-10 border-b border-gray-700">
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6">
              YottaSync adopts a holistic "Concept to Completion" approach. 
              We guide organizations through every phase of their technological journey, 
              from initial concepts to the final realization of tangible business outcomes.
            </p>
       <p className="text-gray-300 mb-6">
        11, Jalan Teknologi 3/3A, Taman Sains<br />
        Selangor 1, Kota Damansara,<br />
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()}   Yottapath Engineering Sdn Bhd. All rights reserved.
          </p>
